...
prefix = /export/home/software/github.com/slimserver-vendor.git/CPAN/build
exec_prefix = ${prefix}
...
CFLAGS = -O1 -fPIC -D_XPG6 -DU_USING_ICU_NAMESPACE=0 -Wall -pedantic -Wshadow -Wpointer-arith -Wmissing-prototypes -Wwrite-strings $(THREADSCFLAGS) 
# CXXFLAGS is for C++ only flags
CXXFLAGS = -O2 -fPIC -D_XPG6 -DU_USING_ICU_NAMESPACE=0 -W -Wall -pedantic -Wpointer-arith -Wwrite-strings -Wno-long-long $(THREADSCXXFLAGS) 
# CPPFLAGS is for C Pre-Processor flags
CPPFLAGS =  $(THREADSCPPFLAGS)  -DU_HAVE_ELF_H=1 -DU_HAVE_ATOMIC=0 -DU_HAVE_STRTOD_L=0 
...
include $(top_srcdir)/config/mh-solaris-gcc
